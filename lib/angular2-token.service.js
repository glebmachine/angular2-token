...
var Angular2TokenService = (function () {
    function Angular2TokenService(http, location, activatedRoute, router) {
        this.http = http;
    ...
    Angular2TokenService.prototype.canActivate = function () {
        if (this.userSignedIn())
            ...
            if (this.atOptions.signInStoredUrlStorageKey) {
                _localStorage.setItem(this.atOptions.signInStoredUrlStorageKey, this.location.pathname + this.location.search);
            }
    ...
    Angular2TokenService.prototype.init = function (options) {
        var defaultOptions = {
            ...
            registerAccountCallback: this.location['href'],
            updatePasswordPath: 'auth',
            resetPasswordPath: 'auth/password',
            resetPasswordCallback: this.location['href'],
            userTypes: null,
            oAuthBase: this.location['origin'],
            oAuthPaths: {
                github: 'auth/github'
            },
    ...
    Angular2TokenService.prototype.get = function (url, options) {
        return this.request(url, this.mergeRequestOptionsArgs({
    ...
    Angular2TokenService.prototype.request = function (url, options) {
        ...
        if (options.headers) {
            Object.assign(baseHeaders, options.headers.toJSON());
            delete options.headers;
        }
        baseRequestOptions.headers = new Headers(baseHeaders);
    ...
    Angular2TokenService.prototype.tryLoadAuthData = function () {
        var userType = this.getUserTypeByName(_localStorage.getItem('userType'));
        if (userType)
